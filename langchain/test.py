...
file = client.files.create(
    file=open("F:/Dustin/Kuliah/afe056718edc8058b7f712386bfabbcf5acdedb94dbd7d4af266bf0e560582ed.pdf", 'rb'),
    purpose='assistants'
)
...
def get_assistant():
    ...
    return client.beta.assistants.create(
        ...
        instructions="You are a helpful assistant designed to output only JSON. process the information from the file that has been given to extract the TOC.",
...
prompt ='''
        give me the title, author, total page, and the lists of TOC from the file, this is the example of the output:
        {   
            'title' : 'title',
            'author' : 'author',
            'total_page': '100'
            'topics': ['Introduction', 'methodology', ...]
        }
        '''
